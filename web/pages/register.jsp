...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/register-js.js"></script>
        ...
        <div class="l-static">
            <div class="static-module-covers">
                <div class="pass-login-covers">
                    ...
                    <div id="addBox" style="display:none;">注册成功，正在跳转</div>
                    <div class="user">
                        <input class="text-style ipt-default-current" type="text" placeholder="用户名" name="username" id="username">
                    </div>
                    <div class="email">
                        <input class="text-style ipt-default-current" type="text" placeholder="邮箱" name="email" id="email">
                    </div>
                    <div class="pwd">
                        <input class="text-style ipt-default-current" type="password" placeholder="密码" name="password" id="password">
                    </div>
                    <div class="confirmpwd">
                        <input class="text-style ipt-default-current" type="password" placeholder="再次确认密码" name="confirm-password" id="confirm-password">
                    </div>
                    <div class="register-btn">
                        <input type="button" id="unregisterbtn" class="btn-current-big btn-disabled" value="注册">
                        <!-- 输入用户名和密码后显示该按钮
                        <input type="button" id="registerbtn" class="btn-current-big btn-default-main loadding-btn hide" value="登录中..."> -->
                    </div>
                    <div class="auto-login">
                        ...
                        <div class="login-links">
                            <a href="#" target="_blank" class="a-auto">忘记找回密码</a>
                            &nbsp; | &nbsp;
                            <a target="_blank" class="a-auto" id="loginBtn">登陆</a>
                        </div>
                    </div>
                </div>
            </div>
